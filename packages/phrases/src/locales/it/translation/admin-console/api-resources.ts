const api_resources = {
  ...
  title: 'Risorse API',
  subtitle: 'Definisci le API che le tue applicazioni autorizzate possono utilizzare',
  ...
  api_identifier_tip:
    "L'identificatore univoco della risorsa API. Deve essere un URI assoluto e non può avere componenti di frammento (#). Corrisponde al parametro <a>risorsa</a> in OAuth 2.0.",
